...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='ros2_marsupial_coordinator',
            executable='pure_pursuit_fixed_LH.py',          # LOOKAHEAD FIJO
            # executable='pure_pursuit_adaptative_LH.py',     # LOOKAHEAD ADAPTATIVO
            name='trajectory_pure_pursuit',
            output='screen',
            arguments=[LaunchConfiguration('yaml_filename')]
        ),

        # Nodo publicador en tf2
        Node(
            package='ros2_marsupial_coordinator',
